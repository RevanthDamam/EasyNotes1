...
import { GraduationCap, Mail, Lock, User, ArrowRight, BookOpen, Users, Star, Zap } from 'lucide-react'
import { motion } from 'framer-motion'

// ── Canvas Ripple (same as Login) ─────────────────────────────────────
  ...
  return (
    <div className="auth-bg min-h-screen flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-16 relative z-10">
        ...
        <motion.div initial={{ opacity:0, y:30 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.7, delay:0.2 }}
          ...
          <div>
            ...
            <p className="mt-5 text-lg text-white/50 leading-relaxed max-w-md">
              Join thousands of students using EasyNotes to access, organize, and master their study materials.
            </p>
          </div>
        ...
        <p className="text-white/20 text-xs">© 2025 EasyNotes. All rights reserved.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative z-10">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-white/40 text-sm mt-1">Join EasyNotes as a student</p>
          </div>
